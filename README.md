...
Converts PDF, Word, PowerPoint and text documents with privacy masking and
custom replacements — same engine as the desktop app. Installable PWA, works
offline. Scanned-doc OCR, audio, spreadsheets and folder ingest stay desktop-only.
